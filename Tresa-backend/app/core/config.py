...
class Settings:
    ...
    renult_app_url: str = os.getenv("RENULT_APP_URL", "https://account.bliss-isp.com").rstrip("/")
    ...
    portal_public_api_url: str = os.getenv("PORTAL_PUBLIC_API_URL", "https://api.bliss-isp.com").rstrip("/")
